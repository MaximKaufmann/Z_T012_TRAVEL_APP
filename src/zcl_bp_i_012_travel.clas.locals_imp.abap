...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_012_travel.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_012_travel FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_012_travel\\travel FROM VALUE #(
  ...
  METHOD calculatetravelkey.
    READ ENTITIES OF zi_012_travel IN LOCAL MODE
        ENTITY Travel
          FIELDS ( travel_id )
    ...
    "Get max travelID
    SELECT SINGLE FROM z012_travel FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).

    "update involved instances
    MODIFY ENTITIES OF zi_012_travel IN LOCAL MODE
      ENTITY Travel
